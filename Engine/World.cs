...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateQuests()
        {
            ...
            Quest clearFarmersField =
                new Quest(
                    ...
                    "Kill snakes in the farmer's field and bring back 3 snake fangs. You will receive an adventurer's pass and 20 gols pieces.", 20, 20);
        ...
        private static void PopulateLocations()
        {
            ...
            Location townSquare = new Location(LOCATION_ID_TOWN_SQUARE, "Town square", "You see the fountain.");
            ...
            alchemistHut.LocationToNorth = townSquare;
